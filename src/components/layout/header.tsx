...
// // //   const { getDisplayName, getDisplayEmail, getDisplayImage, getInitials } = useProfile()
...
// // //   // Get dynamic display values from profile context
...
// // //           {/* Right side icons - tight spacing */}
...
// // //             {/* User Menu - Uses Profile Context */}
// // //             <DropdownMenu>
// // //               <DropdownMenuTrigger asChild>
...
// //   id: string
// //   type: 'task_overdue' | 'task_due_soon' | 'project_deadline' | 'task_completed' | 'task_assigned' | 'project_created'
// //   title: string
// //   message: string
// //   timestamp: Date
// //   isRead: boolean
...
// //             type: 'task_overdue',
// //             title: 'Task Overdue',
// //             message: `"${task.name || task.title}" was due ${formatDistanceToNow(dueDate, { addSuffix: true })}`,
// //             timestamp: dueDate,
...
// //         if (isAfter(dueDate, now) && isBefore(dueDate, threeDaysFromNow)) {
// //           notifs.push({
// //             id: `due-soon-${task.id}`,
// //             type: 'task_due_soon',
// //             title: 'Task Due Soon',
// //             message: `"${task.name || task.title}" is due ${formatDistanceToNow(dueDate, { addSuffix: true })}`,
// //             timestamp: new Date(now.getTime() - 1000 * 60 * 60), // 1 hour ago for sorting
...
// //         if (isAfter(deadline, now) && isBefore(deadline, oneWeekFromNow)) {
// //           notifs.push({
// //             id: `project-deadline-${project.id}`,
// //             type: 'project_deadline',
// //             title: 'Project Deadline Approaching',
// //             message: `Project "${project.name}" deadline is ${formatDistanceToNow(deadline, { addSuffix: true })}`,
...
// //         if (isAfter(completedDate, oneDayAgo)) {
// //           notifs.push({
...
// //     })
// //   }, [tasks, projects, readNotifications])
...
// //                           style={{
// //                             animation: notificationsOpen ? `slideDown 0.2s ease-out ${index * 0.05}s both` : undefined
// //                           }}
// //                           onClick={() => {
